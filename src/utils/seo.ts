...
export function generateSchemaGraph(options: {
  ...
  const localBusinessSchema: any = {
    ...
    url: siteUrl,
    logo: settings.logoUrl ? (settings.logoUrl.startsWith('http') ? settings.logoUrl : `${siteUrl}${settings.logoUrl}`) : `${siteUrl}/images/logo/nk-laser-logo.png`,
    image: `${siteUrl}/images/logo/nk-laser-logo.png`,
