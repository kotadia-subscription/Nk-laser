  ...
  return (
    <>
      ...
      `}>
        ...
        <div className="p-4 sm:p-5 flex items-center justify-between border-b shrink-0 border-slate-200">
          ...
          <button
            onClick={onCloseMobile}
            className="lg:hidden p-1.5 rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-700 cursor-pointer shrink-0"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
